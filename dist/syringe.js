(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}(g.syringe || (g.syringe = {})).ts = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
...
var UnprovidedBinding = (function () {
    ...
    UnprovidedBinding.prototype.toFactory = function (factory) {
        ...
        for (var _i = 1; _i < arguments.length; _i++) {
            dependencyTokens[_i - 1] = arguments[_i];
        }
    ...
    UnprovidedBinding.prototype.toClass = function (Class) {
        ...
        return new Binding(this._token, new facade_1.ClassProvider(Class, dependencyTokens));
    };
...
var Injector = (function () {
    ...
    Injector.prototype._ingestBindings = function () {
        ...
        this._providers = allBindings.map(function (b) {
            return new facade_1.IndexedProvider(b.provider, function (token) { return _this._getIndexForToken(token); });
        });
        var _a;
    };
...
var ClassProvider = (function () {
    ...
    ClassProvider.prototype.get = function (dependencies) {
...
var FactoryProvider = (function () {
    ...
    FactoryProvider.prototype.get = function (dependencies) {
...
var IndexedProvider = (function () {
    function IndexedProvider(provider, getIndexForToken) {
        ...
        this.dependencyIndices = provider.dependencyTokens.map(function (token) { return getIndexForToken(token); });
    }
    IndexedProvider.prototype.get = function (dependencies) {
